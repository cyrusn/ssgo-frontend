<template>
  <div class="my-4">
    <rank-example/>
    <div v-if="successUpdate" class="fade show alert alert-primary" id="successUpdate">上載成功</div>
    <div v-else-if="errorMessage" class="alert alert-danger" v-html="errorMessage"></div>
